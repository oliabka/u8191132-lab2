...
class BuyersController extends Controller
{
    ...
    public function showFiltered(Request $request)
    {
        ...
        $shortRequest = "&blocked=" . $request->get('blocked') . "&email=" . $request->get('email') .
            "&phone=" . $request->get('phone') . "&name=" . $request->get('name');
        ...
        $buyers = $buyers->offset(($page - 1) * 10)->limit(10)->get();
        return view('buyersAll', ['buyers' => $buyers, 'request' => $request, 'shortRequest' => $shortRequest]);
    }
}
